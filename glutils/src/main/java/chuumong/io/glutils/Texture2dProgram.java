...
public class Texture2dProgram {
    ...
    private static final String FRAGMENT_SHADER_EXT_FILT3x3 = "#extension GL_OES_EGL_image_external : require\n" +
    ...
    private static final String FRAGMENT_SHADER_FILT3x3 = "#define KERNEL_SIZE " + KERNEL_SIZE + "\n" +
                                                          "precision highp float;\n" +
                                                          "varying vec2 vTextureCoord;\n" +
                                                          "uniform sampler2D sTexture;\n" +
                                                          "uniform float uKernel[KERNEL_SIZE];\n" +
     ...
     * @param vertexStride    Width, in bytes, of the position data for each vertex (often vertexCount * sizeof(float)).
     * @param texMatrix       A 4x4 transformation matrix for texture coords.
     * @param texBuffer       Buffer with vertex texture data.
     * @param texStride       Width, in bytes, of the texture data for each vertex.
     */
    public void draw(final float[] mvpMatrix, final FloatBuffer vertexBuffer, final int firstVertex, final int vertexCount,
                     final int coordsPerVertex, final int vertexStride, final float[] texMatrix, final FloatBuffer texBuffer,
                     final int textureId, final int texStride) {
